...
<head>
   ...
   <script src="/javascript/bootstrap-dropdownhover.min.js"></script>
	...
	$(function(){
			...
			$( "button[name='before']" ).on("click" , function() {
				history.go(-1)
			});
	...
	<div class="container">
		...
		<div class="row">
	  		<div class="col-md-12 text-center ">
	  			<button type="button" class="btn btn-primary" name="buy">구매</button>
	  			<button type="button" class="btn btn-primary" name="before">이전</button>
	  		</div>
		</div>
