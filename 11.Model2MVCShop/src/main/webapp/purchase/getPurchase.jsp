...
<head>
   ...
   <script src="/javascript/bootstrap-dropdownhover.min.js"></script>
	...
	$(function(){
		...
		$( "button[name='updatePurchase']" ).on("click" , function() {
...
<body>
	...
	<div class="container">
		...
		<div class="page-header">
	       ...
	       <h5 class="text-muted">구매한 상품의 정보를 <strong class="text-danger">최신정보로 관리</strong>해 주세요.</h5>
	    </div>	
		...
		<div class="row">
	  		<div class="col-md-12 text-center ">
	  			<button type="button" class="btn btn-primary" name="updatePurchase">수정</button>
	  			<button type="button" class="btn btn-primary" name="confirm">확인</button>
	  		</div>
		</div>		
