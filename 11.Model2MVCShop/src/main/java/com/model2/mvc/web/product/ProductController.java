...
public class ProductController {
	...
	public String addProduct( @ModelAttribute("product") Product product, 
		...
		//파일을 넣어줄 경로 설정
		String filePath = "C:\\workspace\\11.Model2MVCShop\\src\\main\\webapp\\images\\uploadFiles\\";
		...
		File file = new File(filePath+fileUpload.getOriginalFilename()); //새로운 파일경로에 이름을 설정
		product.setFileName(fileUpload.getOriginalFilename()); // product객체 이름 설정하여 DB 저장 예정 
