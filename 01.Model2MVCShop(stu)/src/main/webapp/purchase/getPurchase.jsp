...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
				<%  if (Integer.parseInt(purchaseVO.getPaymentOption()) == 1) { %> 
						현금구매 
				<%	} else if (Integer.parseInt(purchaseVO.getPaymentOption()) == 2) { %>
					    신용구매 
				<%  } %>
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%= purchaseVO.getBuyer().getPhone() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01"><%= purchaseVO.getBuyer().getAddr() %></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
